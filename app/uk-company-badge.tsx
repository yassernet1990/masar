...
export default function UKCompanyBadge() {
  ...
  return (
    ...
    >
      ...
      <div className="payment-partners" aria-label="Payment partners">
        <span className="payment-partner wise-logo" aria-label="Wise">WISE</span>
        <span className="payment-divider" aria-hidden="true" />
        <span className="payment-partner stripe-logo" aria-label="Stripe">stripe</span>
      </div>
    </div>
  );
}
