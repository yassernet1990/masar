...
import BusinessServiceImageBridge from "./business-service-image-bridge";
...
export default async function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  ...
  return (
    <html lang={lang} dir={lang === "ar" ? "rtl" : "ltr"} suppressHydrationWarning>
      ...
      <body><ThemeBridge /><MasarV17Bridge /><MasarV22Bridge /><MasarMobileMenu /><ServiceTaxonomySync /><BusinessServiceImageBridge />{children}</body>
    </html>
  );
}
