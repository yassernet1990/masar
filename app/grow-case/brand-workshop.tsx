...
export default function BrandWorkshop({ ar }: { ar: boolean }) {
  ...
  const style = { "--brand-base": p.colours[0], "--brand-previous": palettes[previousPalette].colours[0], "--brand-accent": p.colours[1], "--brand-secondary": p.colours[2], "--brand-paper": p.colours[3], "--brand-font-ar": fontPairs[font].ar, "--brand-font-en": fontPairs[font].en } as CSSProperties;
