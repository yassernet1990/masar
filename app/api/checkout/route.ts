    ...
    const session = await stripe().checkout.sessions.create(
      {
        ...
        success_url: `${origin()}/?checkout=success&session_id={CHECKOUT_SESSION_ID}#brand-packages`,
        cancel_url: `${origin()}/?checkout=cancelled#brand-packages`,
        metadata,
        payment_intent_data: { metadata },
        invoice_creation: { enabled: true, invoice_data: { metadata } },
        custom_text: {
          submit: { message: `${refund[lang]} ${current.fee![lang]}` },
        },
